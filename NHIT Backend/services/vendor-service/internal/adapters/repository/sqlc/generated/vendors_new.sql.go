...
SELECT id, tenant_id, vendor_code, vendor_name, vendor_email, vendor_mobile, vendor_type, vendor_nick_name, activity_type, email, mobile, gstin, pan, pin, country_id, state_id, city_id, country_name, state_name, city_name, msme_classification, msme, msme_registration_number, msme_start_date, msme_end_date, material_nature, gst_defaulted, section_206ab_verified, beneficiary_name, remarks_address, common_bank_details, income_tax_type, project, status, from_account_type, account_name, short_name, parent, file_paths, code_auto_generated, is_active, created_by, created_at, updated_at, account_number, name_of_bank, ifsc_code, ifsc_code_id FROM vendors 
