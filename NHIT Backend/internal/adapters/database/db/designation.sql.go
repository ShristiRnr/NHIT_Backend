...
func (q *Queries) ActivateDesignation(ctx context.Context, arg ActivateDesignationParams) error {
	_, err := q.db.ExecContext(ctx, activateDesignation, arg.ID, arg.UpdatedAt)
	return err
}
...
func (q *Queries) CalculateDesignationLevel(ctx context.Context, id uuid.UUID) (interface{}, error) {
	row := q.db.QueryRowContext(ctx, calculateDesignationLevel, id)
...
func (q *Queries) CheckDesignationExists(ctx context.Context, arg CheckDesignationExistsParams) (bool, error) {
	row := q.db.QueryRowContext(ctx, checkDesignationExists, arg.Lower, arg.Column2)
	var exists bool
	err := row.Scan(&exists)
	return exists, err
}
...
func (q *Queries) CheckSlugExists(ctx context.Context, arg CheckSlugExistsParams) (bool, error) {
	row := q.db.QueryRowContext(ctx, checkSlugExists, arg.Slug, arg.Column2)
	var exists bool
	err := row.Scan(&exists)
	return exists, err
}
...
func (q *Queries) CountDesignations(ctx context.Context, arg CountDesignationsParams) (int64, error) {
	row := q.db.QueryRowContext(ctx, countDesignations, arg.Column1, arg.Column2, arg.Column3)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) CreateDesignation(ctx context.Context, arg CreateDesignationParams) (Designation, error) {
	row := q.db.QueryRowContext(ctx, createDesignation,
		arg.ID,
		arg.Name,
		arg.Description,
		arg.Slug,
...
func (q *Queries) DeactivateDesignation(ctx context.Context, arg DeactivateDesignationParams) error {
	_, err := q.db.ExecContext(ctx, deactivateDesignation, arg.ID, arg.UpdatedAt)
	return err
}
...
func (q *Queries) GetActiveDesignations(ctx context.Context) ([]Designation, error) {
	rows, err := q.db.QueryContext(ctx, getActiveDesignations)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetDesignationByID(ctx context.Context, id uuid.UUID) (Designation, error) {
	row := q.db.QueryRowContext(ctx, getDesignationByID, id)
	var i Designation
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) GetDesignationByName(ctx context.Context, lower string) (Designation, error) {
	row := q.db.QueryRowContext(ctx, getDesignationByName, lower)
	var i Designation
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) GetDesignationBySlug(ctx context.Context, slug string) (Designation, error) {
	row := q.db.QueryRowContext(ctx, getDesignationBySlug, slug)
	var i Designation
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) GetDesignationChildren(ctx context.Context, parentID uuid.NullUUID) ([]Designation, error) {
	rows, err := q.db.QueryContext(ctx, getDesignationChildren, parentID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetDesignationLevel(ctx context.Context, id uuid.UUID) (sql.NullInt32, error) {
	row := q.db.QueryRowContext(ctx, getDesignationLevel, id)
	var level sql.NullInt32
	err := row.Scan(&level)
	return level, err
}

const getDesignationUsersCount = `-- name: GetDesignationUsersCount :one
SELECT COUNT(*) FROM users WHERE designation_id = $1
`

func (q *Queries) GetDesignationUsersCount(ctx context.Context, designationID uuid.NullUUID) (int64, error) {
	row := q.db.QueryRowContext(ctx, getDesignationUsersCount, designationID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) GetDesignationsByParent(ctx context.Context, parentID uuid.NullUUID) ([]Designation, error) {
	rows, err := q.db.QueryContext(ctx, getDesignationsByParent, parentID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetRootDesignations(ctx context.Context) ([]Designation, error) {
	rows, err := q.db.QueryContext(ctx, getRootDesignations)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListDesignations(ctx context.Context, arg ListDesignationsParams) ([]Designation, error) {
	rows, err := q.db.QueryContext(ctx, listDesignations,
		arg.Column1,
		arg.Column2,
		arg.Column3,
		arg.Limit,
...
func (q *Queries) UpdateDesignation(ctx context.Context, arg UpdateDesignationParams) (Designation, error) {
	row := q.db.QueryRowContext(ctx, updateDesignation,
		arg.ID,
		arg.Name,
		arg.Description,
		arg.Slug,
...
func (q *Queries) UpdateDesignationUserCount(ctx context.Context, arg UpdateDesignationUserCountParams) error {
	_, err := q.db.ExecContext(ctx, updateDesignationUserCount, arg.ID, arg.UserCount, arg.UpdatedAt)
	return err
}
