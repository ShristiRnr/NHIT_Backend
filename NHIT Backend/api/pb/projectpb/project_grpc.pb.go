...
func (c *projectServiceClient) ListProjectsByOrganization(ctx context.Context, in *ListProjectsByOrganizationRequest, opts ...grpc.CallOption) (*ListProjectsByOrganizationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListProjectsByOrganizationResponse)
	err := c.cc.Invoke(ctx, ProjectService_ListProjectsByOrganization_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProjectService_ListProjectsByOrganization_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListProjectsByOrganizationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProjectServiceServer).ListProjectsByOrganization(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProjectService_ListProjectsByOrganization_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProjectServiceServer).ListProjectsByOrganization(ctx, req.(*ListProjectsByOrganizationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProjectService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/proto/project.proto",
}
