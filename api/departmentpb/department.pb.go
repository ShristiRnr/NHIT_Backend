...
const file_department_proto_rawDesc = "" +
	"\n" +
	"\x10department.proto\x12\vdepartments\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc8\x01\n" +
	"\n" +
	"Department\x12\x0e\n" +
	...
	"\x10CreateDepartment\x12$.departments.CreateDepartmentRequest\x1a\x1f.departments.DepartmentResponse\x12S\n" +
	"\rGetDepartment\x12!.departments.GetDepartmentRequest\x1a\x1f.departments.DepartmentResponse\x12Y\n" +
	"\x10UpdateDepartment\x12$.departments.UpdateDepartmentRequest\x1a\x1f.departments.DepartmentResponse\x12_\n" +
	"\x10DeleteDepartment\x12$.departments.DeleteDepartmentRequest\x1a%.departments.DeleteDepartmentResponse\x12\\\n" +
	"\x0fListDepartments\x12#.departments.ListDepartmentsRequest\x1a$.departments.ListDepartmentsResponseB\x1fZ\x1dapi/departmentpb;departmentpbb\x06proto3"
